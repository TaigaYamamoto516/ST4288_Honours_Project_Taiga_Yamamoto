...
class RMSprop_IKSA_Min(Optimizer):
    ...
    def __init__(self, params, function, lr=1e-2, alpha=0.99, eps=1e-8, weight_decay=0, momentum=0, centered=False, eps_iksa = 1):
        ...
        super(RMSprop_IKSA_Min, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(RMSprop_IKSA_Min, self).__setstate__(state)
...
class RMSprop_IKSA_Max(Optimizer):
    ...
    def __init__(self, params, function, lr=1e-2, alpha=0.99, eps=1e-8, weight_decay=0, momentum=0, centered=False, eps_iksa = 1):
        ...
        super(RMSprop_IKSA_Max, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(RMSprop_IKSA_Max, self).__setstate__(state)
        for group in self.param_groups:
            group.setdefault('momentum', 0)
            group.setdefault('centered', False)
