...
class Adam_IKSA_Min(Optimizer):
    ...
    def __init__(self, params, function, lr=0.0002, betas=(0.1, 0.99), eps=1e-8,
        ...
        super(Adam_IKSA_Min, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(Adam_IKSA_MIn, self).__setstate__(state)
...
class Adam_IKSA_Max(Optimizer):
    ...
    def __init__(self, params, function, lr=0.0002, betas=(0.1, 0.99), eps=1e-8,
        ...
        super(Adam_IKSA_Max, self).__init__(params, defaults)

    def __setstate__(self, state):
        super(Adam_IKSA_Max, self).__setstate__(state)
        for group in self.param_groups:
            group.setdefault('amsgrad', False)
